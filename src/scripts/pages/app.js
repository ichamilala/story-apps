import { matchRoute, getActiveRoute } from '../routes/url-parser';
import {
...
export default class App {
  ...
  async renderPage() {
    ...
    if (!matched || typeof matched.route.page !== 'function') {
      console.error(`Route for "${url}" not found or is not a function.`, matched?.route?.page);
      this.#content.innerHTML = '<p>Halaman tidak ditemukan.</p>';
      return;
    }

    const page = matched.route.page();
